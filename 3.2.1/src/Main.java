...
public class Main {
    ...
    public static String CompareSimbolsURL(URL url1,URL url2) throws Exception{
    ...
    public static void main(String[] args) {
        try{
            ...
            URL url1 = new URL("https://www.cyberforum.ru/java-j2se/");
            URL url2 = new URL("https://www.cyberforum.ru/java-j2se/");
            PrintWriter writer = new PrintWriter(file3);
            writer.print(CompareSimbolsURL(url1,url2)+"111");
            writer.close();
        }catch (IOException e){
            e.getStackTrace();
        }catch (Exception e1){
